    ...
    return (<>
        ...
        <div className="bg-white xl:px-12 p-4">
            ...
            <div className='mt-10'>
                ...
                <div className='card-item shadow-md overflow-hidden'>
                    <div className='card-img p-8 bg-slate-50'>
                        <Link to=""><img src="/berry_mix.webp" alt="berrymix" className='mx-auto transform transition-transform duration-300 hover:scale-110' /></Link>
                    </div>
                    <div className='card-details p-2'>
                        <div className='desc mb-2 text-sm font-semibold'><Link to="">Farmley Berries Mix 160g | 8-In-1 Healthly Snacks Contains Cranberry,Black</Link></div>
                        <div className='flex justify-between items-center price cart-btn'><strong>Rs.240</strong>
                            <button className='p-1 bg-orange-400 text-white text-sm rounded-full font-semibold'>Add Cart</button>
                        </div>
                        <div><span className='text-sm text-red-500'><Link to="">More Details...</Link></span></div>
                    </div>
                </div>
                ...
                <div className='card-item shadow-md overflow-hidden'>
                    <div className='card-img p-8 bg-slate-50'>
                        <Link to=""><img src="/french_fries.webp" alt="berrymix" className='mx-auto transform transition-transform duration-300 hover:scale-110' /></Link>
                    </div>
                    <div className='card-details p-2'>
                        <div className='desc mb-2 text-sm font-semibold'><Link to="">Farmley Berries Mix 160g | 8-In-1 Healthly Snacks Contains Cranberry,</Link></div>
                        <div className='flex justify-between items-center price cart-btn'><strong>Rs.240</strong>
                            <button className='p-1 bg-orange-400 text-white text-sm rounded-full font-semibold'>Add Cart</button>
                        </div>
                        <div><span className='text-sm text-red-500'><Link to="">More Details...</Link></span></div>
                ...
                <div className='card-item shadow-md overflow-hidden'>
                    ...
                    <div className='card-details p-2'>
                        <div className='desc mb-2 text-sm font-semibold'><Link to="">Farmley Berries</Link></div>
                        <div className='flex justify-between items-center price cart-btn'><strong>Rs.240</strong>
                            <button className='p-1 bg-orange-400 text-white text-sm rounded-full font-semibold'>Add Cart</button>
                        </div>
                        <div><span className='text-sm text-red-500'><Link to="">More Details...</Link></span></div>
                ...
                <div className='card-item shadow-md overflow-hidden'>
                    ...
                    <div className='card-details p-2'>
                        <div className='desc mb-2 text-sm font-semibold'><Link to="">Farmley Berries Mix 160g | 8-In-1 Healthly Snacks </Link></div>
                        <div className='flex justify-between items-center price cart-btn'><strong>Rs.240</strong>
                            <button className='p-1 bg-orange-400 text-white text-sm rounded-full font-semibold'>Add Cart</button>
                        </div>
                        <div><span className='text-sm text-red-500'><Link to="">More Details...</Link></span></div>
